    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div3 = element("div");
    			div3.textContent = "Bottom";
    			attr_dev(div0, "class", "sideBar flex-none svelte-1d1ugd6");
    			add_location(div0, file, 6, 12, 121);
    			attr_dev(div1, "class", "mainScreen flex-1 svelte-1d1ugd6");
    			add_location(div1, file, 7, 12, 172);
    			attr_dev(div2, "class", "flex flex-1 svelte-1d1ugd6");
    			add_location(div2, file, 5, 8, 82);
    			attr_dev(div3, "class", "bottomBar h-24 svelte-1d1ugd6");
    			add_location(div3, file, 10, 8, 237);
    			attr_dev(div4, "class", "flex flex-col h-screen svelte-1d1ugd6");
    			add_location(div4, file, 4, 4, 36);
    			attr_dev(main, "class", "svelte-1d1ugd6");
